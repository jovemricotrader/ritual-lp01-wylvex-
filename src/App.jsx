...
export default function App(){
  ...
  const handleSubmit=async()=>{
    ...
    setLoading(true);
    const dadosCompletos={...res,...form,nome:sanitize(form.nome),clinica:sanitize(form.clinica),whatsapp:sanitize(form.whatsapp),perda,score:Math.min(95,70+(perda>5000?15:5)+(res.dor?10:0))};
  ...
  return(
    <div ref={topo} style={{fontFamily:"'Jost',sans-serif",background:"#080407",color:"#e8d8cc",minHeight:"100vh",overflowX:"hidden",cursor:isMobile||isTablet?"auto":"none"}}>
      <style>{`
      ...
      {/* NAV */}
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:500,height:52,display:"flex",alignItems:"center",justifyContent:"space-between",padding:`0 ${isMobile?"18px":isTablet?"28px":"clamp(24px,6vw,64px)"}`,background:scrollY>40?"rgba(8,4,7,.94)":"transparent",backdropFilter:scrollY>40?"blur(24px)":"none",borderBottom:scrollY>40?"1px solid rgba(201,149,108,.07)":"none",transition:"all .4s"}}>
      ...
      {fase==="hero"&&(
        <div className="grain">
          {/* S1 — HERO PRINCIPAL */}
          <section style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:`clamp(90px,12vh,120px) ${isMobile?"20px":isTablet?"40px":"clamp(24px,8vw,100px)"} 80px`,textAlign:"center",position:"relative",overflow:"hidden"}}>
            <ParticleCanvas/>
            {/* Orbs */}
            ...
            <div style={{position:"relative",zIndex:1,maxWidth:900,width:"100%"}}>
              ...
              {/* CTAs */}
              <div style={{display:"flex",flexDirection:isMobile||isTablet?"column":"row",gap:12,justifyContent:"center",alignItems:"center",animation:"fadeUp .7s ease .3s both"}}>
              ...
              {/* Stats */}
              <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":isTablet?"1fr 1fr":"repeat(4,1fr)",gap:0,marginTop:52,background:"rgba(255,255,255,.02)",border:"1px solid rgba(255,255,255,.05)",borderRadius:14,overflow:"hidden",animation:"fadeUp .7s ease .45s both"}}>
          ...
          {/* S2 — O PROBLEMA */}
          <section style={{background:"#f5ede8",padding:`clamp(80px,10vh,120px) ${isMobile?"20px":isTablet?"40px":"clamp(20px,8vw,100px)"}`,position:"relative",overflow:"hidden"}}>
            ...
            <div style={{maxWidth:960,margin:"0 auto",position:"relative",zIndex:1}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":isTablet?"1fr 1fr":"1fr 1fr",gap:24,marginTop:16}}>
                <Reveal delay={100}>
          ...
          {/* S3 — O QUE FAZ */}
          <section style={{background:"#080407",padding:`clamp(80px,10vh,120px) ${isMobile?"20px":isTablet?"40px":"clamp(20px,8vw,100px)"}`,position:"relative",overflow:"hidden"}}>
            ...
            <div style={{maxWidth:960,margin:"0 auto",position:"relative",zIndex:1}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":isTablet?"1fr 1fr":"1fr 1fr 1fr",gap:12,marginBottom:40}}>
                {[
          ...
          {/* S4 — NÚMEROS */}
          <section style={{background:"linear-gradient(150deg,#2a0d04 0%,#4a1e0a 50%,#6a2e14 100%)",padding:`clamp(80px,10vh,120px) ${isMobile?"20px":isTablet?"40px":"clamp(20px,8vw,100px)"}`,position:"relative",overflow:"hidden"}}>
      ...
      {fase==="form"&&(
        <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:`80px ${isMobile?"16px":"24px"}`,position:"relative",background:"#080407"}}>
          <ParticleCanvas/>
          <div style={{width:"100%",maxWidth:isTablet?520:580,position:"relative",zIndex:1}}>
            {/* Progress */}
            <div className="prog">
